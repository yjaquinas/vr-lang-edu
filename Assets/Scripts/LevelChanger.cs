...
public class LevelChanger : Singleton<LevelChanger>
{
    ...
    public void FadeToLevel(string sceneName)
    {
        ...
        // 20190109 영준 추가 - 
        if(_sceneName == "SpeakingPractice")
        {
            PlayerPrefs.SetString("PRACTICE_MODE", "speaking");
            _sceneName = "Practice";
        }
        else if(_sceneName == "ListeningPractice")
        {
            PlayerPrefs.SetString("PRACTICE_MODE", "listening");
            _sceneName = "Practice";
        }
        // - 20190109 영준 추가
        _changeMod = ChangeMod.String;

        Debug.Log("moving to " + _sceneName);
        Animator.SetTrigger("FadeOut");
    }
